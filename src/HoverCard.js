        ...
        <div class="image" id="i0">
          <div class="city">
            ...
            <svg
              ...
              y="0px"
              viewBox="0 0 300 225"
              style={{enableBackground: "new 0 0 300 225"}}
            >
              <ellipse
                class="st4"
                id="sh1"
        ...
        <div class="story" id="s0">
          <div class="info">
            ...
            <p>
              ...
              powerful civilizations in the world. Their massive scale reflects
              the unique role that the pharaoh played in ancient Egyptian
              society.
            </p>
          </div>
        </div>
      ...
      <div class="container" id="c1">
        ...
        <div class="story" id="s1">
          <div class="info">
            <h3>Stonehenge</h3>
            <p>
              Stonehenge is a prehistoric monument in Wiltshire, England. It was
              constructed in several stages between 3000 and 1500 B.C.,
